...
export const TEXTS: TextSeed[] = [
  ...
  },
  {
    ...
    text_key: 'menu.invest.input_data',
    module_code: 'INVEST',
    kind: 'menu_item',
    default_text: 'Input de Dados',
  },
  {
    id: '00000000-0000-4003-8000-000000000027',
    text_key: 'menu.invest.input_data.initial_load',
    module_code: 'INVEST',
    kind: 'menu_item',
    default_text: 'Carga inicial',
  },
  {
    id: '00000000-0000-4003-8000-000000000028',
    text_key: 'menu.invest.input_data.incremental',
    module_code: 'INVEST',
    kind: 'menu_item',
    default_text: 'Novas movimentacoes',
  },
  {
...
export const MENU: MenuSeed[] = [
  ...
  {
    id: '00000000-0000-4004-8000-000000000071',
    code: 'invest.input_data.initial_load',
    parent_code: 'invest.input_data',
    module_code: 'INVEST',
  ...
  {
    id: '00000000-0000-4004-8000-000000000072',
    code: 'invest.input_data.incremental',
    parent_code: 'invest.input_data',
    module_code: 'INVEST',
