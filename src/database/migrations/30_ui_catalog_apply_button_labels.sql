...
VALUES
  ...
  ('00000000-0000-4003-8000-000000000181', 'action.platform.ui_catalog_apply.hint', 'CORE', 'field_label', 'Grava textos curtos do catálogo (Opções Cards, filtros, menu) no MySQL deste ambiente.', 'pt-BR'),
