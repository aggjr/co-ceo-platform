...
export const LEGACY_ROUTES: LegacyRouteDef[] = [
  ...
  { path: '/invest/input-dados', loader: InvestIntegracaoMensalPage },
  { path: '/invest/input-dados/carga-inicial', loader: InvestIntegracaoMensalPage },
  { path: '/invest/input-dados/novas-movimentacoes', loader: InvestIntegracaoMensalPage },
